      ...
      <main className="grow">
        ...
        <div className='flex flex-row'>
          <div className='h-full'>
            <Sidebar>
              <Menu>
                <MenuItem component={<Link to="/creators" />}> Buscar Creadores </MenuItem>
                <MenuItem component={<Link to="/profile" />}> Crear perfil</MenuItem>
              </Menu>
            </Sidebar>
          </div>
          <div>
              ...
              {profileList ? profileList.map((item, index) => (
                ...
                <div class="bg-white my-12 pb-6 w-full justify-center items-center overflow-hidden md:max-w-sm rounded-lg shadow-sm mx-auto">
                  <div class="relative h-40">
                    <img class="absolute h-full w-full object-cover" src={item.pfpicture} />
                  </div>
                  <div class="relative shadow mx-auto h-24 w-24 -my-12 border-white rounded-full overflow-hidden border-4">
                    <img class="object-cover w-full h-full" src={item.pfpicture} />
                  </div>
                  <div class="mt-16">
                    <h1 class="text-lg text-center font-semibold text-black">
                      {item.nickname.toString()}
                    </h1>
                    <p class="text-sm text-gray-600 text-center break-normal">
